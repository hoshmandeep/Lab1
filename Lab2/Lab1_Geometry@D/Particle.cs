...
namespace Lab1_Geometry2D.Particles
{
	public abstract class Particle
	{
		...
		{
			get => direction; // Fix this to preserve encaplation
			set => direction = value;
		}
		...
		/// Copy Constructor
		/// </summary>
		/// <param name="p">The incoming partical to copy</param>param>
		...
		{
			/* At time 0, our partical is at postion (x,y) with direction (i,j) and speed (v) 
			 * If we move our partical for (t) seconds -> what will the new position be?
